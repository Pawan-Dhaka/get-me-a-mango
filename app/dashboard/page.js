...
const page = () => {
  ...
  useEffect(() => {
    document.title="Dashboard - Get me a Mango"
    ...
    <ToastContainer
      ...
      <div className='container mx-auto py-5 px-6 '>
        ...
        <form className="max-w-2xl mx-auto" action={handleSubmit}>
          ...
          <div className='my-2'>
            <label htmlFor="bio" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bio(upto 30 characters)</label>
          ...
          {/* Submit Button  */}
          <div className="my-6">
            <button type="submit" className="block w-full p-2 text-black font-bold bg-green-500 rounded-lg hover:bg-green-600   dark:focus:ring-blue-800  text-sm">Save</button>
          </div>
        </form>
